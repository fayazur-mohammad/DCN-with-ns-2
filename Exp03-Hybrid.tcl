...
set tracefile [open Exp03-Hybrid.tr w]
$ns trace-all $tracefile

#Open the NAM trace file
set namfile [open Exp03-Hybrid.nam w]
...
$ns duplex-link $n5 $n6 3.0Mb 10ms DropTail
$ns queue-limit $n5 $n6 50

set lan [$ns newLan "$n3 $n4 $n5" 3Mb 10ms LL Queue/DropTail MAC/Csma/Cd Channel]
